...
const Navigate = () => {
  ...
  return (
    <>
        <nav className="flex max-md:justify-between max-md:bg-neutral-950/95 md:flex-col items-center justify-center gap-5 fixed md:h-screen md:right-6 bottom-0 max-md:w-full max-md:p-3 z-50">
