      ...
      <div className="slide-in-top">
        ...
        <div className="flex flex-col gap-10 xl:flex-row pt-10 pb-20 md:py-20">
          <div className="xl:w-1/2">
            ...
            <a href="https://docs.google.com/document/d/1abq-_PNx4uZ8LoW2LPz6mwUvdtYqQnuf1EoNo6RWUuY" target="_blank" className="font-semibold cursor-pointer border border-yellow-500 rounded-full relative inline-flex items-center justify-start overflow-hidden transition-all   group">
