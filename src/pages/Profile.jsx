...
const Profile = () => {
  ...
  return (
    ...
    <section className="p-20">
        <p className="font-black text-6xl text-neutral-800 uppercase">Resumen</p>
        <h1 className='font-black text-5xl text-white uppercase text-center'>Sobre <span className='text-yellow-500'>Mí</span></h1>
        <div className="flex py-20">
          <div className="w-1/2">
            <h2 className='font-bold text-3xl text-white uppercase'>Información Personal</h2>
            <div className="flex py-10">
              ...
              <div className="w-1/2 space-y-3">
                ...
                <p className='text-gray-300'>Email: <span className='text-white font-semibold'>contrerasalfonso.lino@gmail.com</span></p>
          ...
          <div className="w-1/2 px-3">
            <h2 className='font-bold text-3xl text-white uppercase mb-5'>Educación</h2>
            <div className="border-l border-neutral-500 p-4 space-y-3 py-5">
              ...
              <p className="text-white">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Culpa ducimus nemo, pariatur debitis fuga consequatur quibusdam velit</p>
            </div>
        ...
        <hr className="w-96 h-0   border-1 border-neutral-950 rounded mx-auto"/>


        <div>
          <h2 className='font-bold text-3xl text-white uppercase text-center my-12'>Mis Skills</h2>
